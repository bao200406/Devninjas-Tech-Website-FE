...
import { useParams, useRouter } from "next/navigation"; // Nếu dùng App Router
// Import các service của bạn
import { getProductById, updateProduct } from "../../../../../services/productService";
import { getAllCategories } from "../../../../../services/categoryService";
import { getAllBrands } from "../../../../../services/brandService";
import { getAllAttributes } from "../../../../../services/attributeService";
import { updateVariants } from "../../../../../services/variantsService";
...
export default function EditProductPage() {
  ...
  useEffect(() => {
    const initData = async () => {
      try {
        const [cats, brds, attrs, product] = await Promise.all([
          getAllCategories(),
          getAllBrands(),
          getAllAttributes(),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const generatedSlug = formData.name.toLowerCase().trim().normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "").replace(/[^\w\s-]/g, "").replace(/[\s_-]+/g, "-");
